...
class Resp {
  ...
  _makeCmdNames() {
    ...
    const commandsRegistryTime = this._busClient.getCommandsRegistryTime();
    if (this._cmdNamesTime === commandsRegistryTime) {
    ...
    this._cmdNamesTime = commandsRegistryTime;
  }
